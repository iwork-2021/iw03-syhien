//
//  InformatizationNewsTableViewController.swift
//  ITSC
//
...
class InformatizationNewsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "InformatizationNewsTemplateCell", for: indexPath) as! TemplateTableViewCell
...
extension InformatizationNewsTableViewController: UISearchBarDelegate {
