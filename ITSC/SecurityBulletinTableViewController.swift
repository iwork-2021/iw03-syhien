//
//  SecurityBulletinTableViewController.swift
//  ITSC
//
...
class SecurityBulletinTableViewController: UITableViewController {
...
//                print(pageNumber)
        ...
        for page in 1...pageNumber {
            let operation = BlockOperation {
                let urlString = "https://itsc.nju.edu.cn/aqtg/list" + String(page) + ".htm"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "SecurityBulletinTemplateCell", for: indexPath) as! TemplateTableViewCell
...
extension SecurityBulletinTableViewController: UISearchBarDelegate {
